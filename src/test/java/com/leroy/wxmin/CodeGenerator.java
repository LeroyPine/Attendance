...
import static com.leroy.attendance.ProjectConstant.*;
...
public class CodeGenerator {
	// JDBC配置，请修改为你项目的实际配置
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/attendance?serverTimezone=UTC&characterEncoding=utf8&useSSL=false";
	private static final String JDBC_USERNAME = "root";
	private static final String JDBC_PASSWORD = "leroy";
	...
	private static final String AUTHOR = "leroy";// @author
	private static final String DATE = new SimpleDateFormat("yyyy-MM-dd").format(new Date());// @date


	// idea 在使用时, 需要在项目基础路径中加入model名称
	public static void main(String[] args) {
		...
		//genModelAndMapper("ep_qj_answer", null);
		 ...
		 //genCodeByCustomModelName("mchtadd",null);
	}
